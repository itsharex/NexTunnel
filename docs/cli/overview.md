...
nextunnel server install --version v0.3.3-alpha --non-interactive --public-host <公网IP或域名>
...
nextunnel server up
nextunnel server update --version v0.3.3-alpha
...
| 参数 | 说明 |
| --- | --- |
| `--version` | GitHub Release 版本，例如 `v0.3.3-alpha` |
